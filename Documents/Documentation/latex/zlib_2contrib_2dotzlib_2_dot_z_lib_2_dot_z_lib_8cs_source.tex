\hypertarget{zlib_2contrib_2dotzlib_2_dot_z_lib_2_dot_z_lib_8cs_source}{}\section{zlib/contrib/dotzlib/\+Dot\+Z\+Lib/\+Dot\+Z\+Lib.cs}
\label{zlib_2contrib_2dotzlib_2_dot_z_lib_2_dot_z_lib_8cs_source}\index{Dot\+Z\+Lib.\+cs@{Dot\+Z\+Lib.\+cs}}
...
00087     \{
\Hypertarget{zlib_2contrib_2dotzlib_2_dot_z_lib_2_dot_z_lib_8cs_source_l00094}\hyperlink{class_dot_z_lib_1_1_z_lib_exception_a6a413e419130b98ef8a443a74b2f8ded}{00094}         \textcolor{keyword}{public} \hyperlink{class_dot_z_lib_1_1_z_lib_exception_a6a413e419130b98ef8a443a74b2f8ded}{ZLibException}(\textcolor{keywordtype}{int} errorCode, \textcolor{keywordtype}{string} msg) : base(String.Format(\textcolor{stringliteral}{"ZLib error \{0\}
       \{1\}"}, errorCode, msg))
00095         \{
00096         \}
00097 
\Hypertarget{zlib_2contrib_2dotzlib_2_dot_z_lib_2_dot_z_lib_8cs_source_l00103}\hyperlink{class_dot_z_lib_1_1_z_lib_exception_af8dd9c725ef7bd7b2d2042e827ce9fb7}{00103}         \textcolor{keyword}{public} \hyperlink{class_dot_z_lib_1_1_z_lib_exception_af8dd9c725ef7bd7b2d2042e827ce9fb7}{ZLibException}(\textcolor{keywordtype}{int} errorCode) : base(String.Format(\textcolor{stringliteral}{"ZLib error \{0\}"}, errorCode))
00104         \{
00105         \}
00106     \}
...
00110 
00114     \textcolor{keyword}{public} \textcolor{keyword}{interface }\hyperlink{interface_dot_z_lib_1_1_checksum_generator}{ChecksumGenerator}
00115     \{
00119         uint Value \{ \textcolor{keyword}{get}; \}
00120 
...
00170 
00174     \textcolor{keyword}{public} \textcolor{keyword}{interface }\hyperlink{interface_dot_z_lib_1_1_codec}{Codec}
00175     \{
00179         \textcolor{keyword}{event} DataAvailableHandler DataAvailable;
00180 
...
00201 
00205         uint Checksum \{ \textcolor{keyword}{get}; \}
00206 
00207 
00208     \}
00209 
...
00241 
\Hypertarget{zlib_2contrib_2dotzlib_2_dot_z_lib_2_dot_z_lib_8cs_source_l00245}\hyperlink{class_dot_z_lib_1_1_info_a48b690fe56ca7cc8e8a40a740476696b}{00245}         \textcolor{keyword}{public} \hyperlink{class_dot_z_lib_1_1_info_a48b690fe56ca7cc8e8a40a740476696b}{Info}()
00246         \{
00247             \_flags = zlibCompileFlags();
00248         \}
00249 
00253         \textcolor{keyword}{public} \textcolor{keywordtype}{bool} HasDebugInfo \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} 0 != (\_flags & 0x100); \} \}
00254 
00258         \textcolor{keyword}{public} \textcolor{keywordtype}{bool} UsesAssemblyCode \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} 0 != (\_flags & 0x200); \} \}
00259 
00263         \textcolor{keyword}{public} \textcolor{keywordtype}{int} SizeOfUInt \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} bitSize(\_flags & 3); \} \}
00264 
00268         \textcolor{keyword}{public} \textcolor{keywordtype}{int} SizeOfULong \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} bitSize((\_flags >> 2) & 3); \} \}
00269 
00273         \textcolor{keyword}{public} \textcolor{keywordtype}{int} SizeOfPointer \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} bitSize((\_flags >> 4) & 3); \} \}
00274 
00278         \textcolor{keyword}{public} \textcolor{keywordtype}{int} SizeOfOffset \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} bitSize((\_flags >> 6) & 3); \} \}
00279 
00283         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{string} Version \{ \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} zlibVersion(); \} \}
00284     \}
00285 
