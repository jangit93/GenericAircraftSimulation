\hypertarget{matio_2visual__studio_2test_2eigen_2blas_2testing_2sblat3_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/blas/testing/sblat3.f}
\label{matio_2visual__studio_2test_2eigen_2blas_2testing_2sblat3_8f_source}\index{sblat3.\+f@{sblat3.\+f}}
...
00123       \textcolor{keywordtype}{LOGICAL}            lse
00124       \textcolor{keywordtype}{EXTERNAL}           sdiff, lse
00125 \textcolor{comment}{*     .. External Subroutines ..}
00126       \textcolor{keywordtype}{EXTERNAL}           schk1, schk2, schk3, schk4, schk5, schke, smmch
...
00137       \textcolor{keyword}{DATA}               snames/\textcolor{stringliteral}{'SGEMM '}, \textcolor{stringliteral}{'SSYMM '}, \textcolor{stringliteral}{'STRMM '}, \textcolor{stringliteral}{'STRSM '},
00138      $                   \textcolor{stringliteral}{'SSYRK '}, \textcolor{stringliteral}{'SSYR2K'}/
...
00145       \textcolor{keyword}{OPEN}( nout, \hyperlink{structfile}{file} = summry )
00146       noutc = nout
...
00154          \textcolor{keyword}{OPEN}( ntra, \hyperlink{structfile}{file} = snaps )
...
00234 \textcolor{comment}{*     Check the reliability of SMMCH using exact data.}
...
00248 \textcolor{comment}{*     CC holds the exact result. On exit from SMMCH CT holds}
00249 \textcolor{comment}{*     the result computed by SMMCH.}
00250       transa = \textcolor{stringliteral}{'N'}
00251       transb = \textcolor{stringliteral}{'N'}
00252       \textcolor{keyword}{CALL }smmch( transa, transb, n, 1, n, one, ab, nmax,
00253      $            ab( 1, nmax + 1 ), nmax, zero, c, nmax, ct, g, cc,
00254      $            nmax, eps, err, fatal, nout, .true. )
00255       same = lse( cc, ct, n )
...
00261       \textcolor{keyword}{CALL }smmch( transa, transb, n, 1, n, one, ab, nmax,
00262      $            ab( 1, nmax + 1 ), nmax, zero, c, nmax, ct, g, cc,
00263      $            nmax, eps, err, fatal, nout, .true. )
00264       same = lse( cc, ct, n )
...
00279       \textcolor{keyword}{CALL }smmch( transa, transb, n, 1, n, one, ab, nmax,
00280      $            ab( 1, nmax + 1 ), nmax, zero, c, nmax, ct, g, cc,
00281      $            nmax, eps, err, fatal, nout, .true. )
00282       same = lse( cc, ct, n )
...
00288       \textcolor{keyword}{CALL }smmch( transa, transb, n, 1, n, one, ab, nmax,
00289      $            ab( 1, nmax + 1 ), nmax, zero, c, nmax, ct, g, cc,
00290      $            nmax, eps, err, fatal, nout, .true. )
00291       same = lse( cc, ct, n )
...
00380  9989 \textcolor{keyword}{FORMAT}( \textcolor{stringliteral}{' ERROR IN SMMCH -  IN-LINE DOT PRODUCTS ARE BEING EVALU'},
00381      $      \textcolor{stringliteral}{'ATED WRONGLY.'}, /\textcolor{stringliteral}{' SMMCH WAS CALLED WITH TRANSA = '}, a1,
...
00410       \textcolor{keywordtype}{REAL}               zero
...
00495                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, ma, na, a, nmax, aa, lda,
00496      $                        reset, zero )
...
00566      $                        rewind ntra
00567                            \textcolor{keyword}{CALL }sgemm( transa, transb, m, n, k, alpha,
...
00586                            isame( 7 ) = lse( as, aa, laa )
00587                            isame( 8 ) = ldas.EQ.lda
00588                            isame( 9 ) = lse( bs, bb, lbb )
...
00691       \textcolor{keywordtype}{REAL}               zero
00692       parameter( zero = 0.0 )
00693 \textcolor{comment}{*     .. Scalar Arguments ..}
00694       \textcolor{keywordtype}{REAL}               eps, thresh
...
00699       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ), alf( nalf ),
...
00706       \textcolor{keywordtype}{REAL}               alpha, als, beta, bls, err, errmax
...
00762             \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, m, n, b, nmax, bb, ldb, reset,
00763      $                  zero )
...
00788                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'SY'}, uplo, \textcolor{stringliteral}{' '}, na, na, a, nmax, aa, lda,
00789      $                        reset, zero )
...
00799                         \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, m, n, c, nmax, cc,
...
00883                               \textcolor{keyword}{CALL }smmch( \textcolor{stringliteral}{'N'}, \textcolor{stringliteral}{'N'}, m, n, m, alpha, a,
...
01059                            \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'TR'}, uplo, diag, na, na, a,
01060      $                                 nmax, aa, lda, reset, zero )
01061 \textcolor{comment}{*}
01062 \textcolor{comment}{*                          Generate the matrix B.}
01063 \textcolor{comment}{*}
01064                            \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, m, n, b, nmax,
...
01096      $                           rewind ntra
01097                               \textcolor{keyword}{CALL }strmm( side, uplo, transa, diag, m,
...
01157                                     \textcolor{keyword}{CALL }smmch( transa, \textcolor{stringliteral}{'N'}, m, n, m,
01158      $                                          alpha, a, nmax, b, nmax,
01159      $                                          zero, c, nmax, ct, g,
01160      $                                          bb, ldb, eps, err,
01161      $                                          fatal, nout, .true. )
01162                                  \textcolor{keywordflow}{ELSE}
01163                                     \textcolor{keyword}{CALL }smmch( \textcolor{stringliteral}{'N'}, transa, m, n, n,
...
01184                                     \textcolor{keyword}{CALL }smmch( transa, \textcolor{stringliteral}{'N'}, m, n, m,
01185      $                                          one, a, nmax, c, nmax,
01186      $                                          zero, b, nmax, ct, g,
01187      $                                          bb, ldb, eps, err,
01188      $                                          fatal, nout, .false. )
01189                                  \textcolor{keywordflow}{ELSE}
01190                                     \textcolor{keyword}{CALL }smmch( \textcolor{stringliteral}{'N'}, transa, m, n, n,
...
01266       \textcolor{keywordtype}{REAL}               zero
01267       parameter( zero = 0.0 )
01268 \textcolor{comment}{*     .. Scalar Arguments ..}
01269       \textcolor{keywordtype}{REAL}               eps, thresh
...
01274       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ), alf( nalf ),
...
01281       \textcolor{keywordtype}{REAL}               alpha, als, beta, bets, err, errmax
...
01636                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, ma, na, ab( k + 1 ),
01637      $                        2*nmax, bb, ldb, reset, zero )
01638                \textcolor{keywordflow}{ELSE}
01639                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, ma, na, ab( k*nmax + 1 ),
...
01655                         \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'SY'}, uplo, \textcolor{stringliteral}{' '}, n, n, c, nmax, cc,
...
01687      $                     rewind ntra
01688                         \textcolor{keyword}{CALL }ssyr2k( uplo, trans, n, k, alpha, aa, lda,
...
01767                                  \textcolor{keyword}{CALL }smmch( \textcolor{stringliteral}{'N'}, \textcolor{stringliteral}{'N'}, lj, 1, 2*k,
...
02531       \textcolor{keywordtype}{REAL}               a( lda, * ), b( ldb, * ), c( ldc, * ),
02532      $                   cc( ldcc, * ), ct( * ), g( * )
02533 \textcolor{comment}{*     .. Local Scalars ..}
02534       \textcolor{keywordtype}{REAL}               erri
...
02627 \textcolor{comment}{*     End of SMMCH.}
02628 \textcolor{comment}{*}
02629 \textcolor{keyword}{      END}
02630 \textcolor{keyword}{      LOGICAL }\textcolor{keyword}{FUNCTION }lse( RI, RJ, LR )
...
02645       \textcolor{keywordtype}{REAL}               ri( * ), rj( * )
...
02659 \textcolor{comment}{*     End of LSE.}
02660 \textcolor{comment}{*}
02661 \textcolor{keyword}{      END}
02662 \textcolor{keyword}{      LOGICAL }\textcolor{keyword}{FUNCTION }lseres( TYPE, UPLO, M, N, AA, AS, LDA )
...
02681       \textcolor{keywordtype}{REAL}               aa( lda, * ), as( lda, * )
