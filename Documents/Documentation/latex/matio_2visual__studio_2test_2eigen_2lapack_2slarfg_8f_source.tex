\hypertarget{matio_2visual__studio_2test_2eigen_2lapack_2slarfg_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/lapack/slarfg.f}
\label{matio_2visual__studio_2test_2eigen_2lapack_2slarfg_8f_source}\index{slarfg.\+f@{slarfg.\+f}}
...
00140       \textcolor{keywordtype}{EXTERNAL}           sscal
...
00160          beta = -sign( slapy2( alpha, xnorm ), alpha )
00161          safmin = slamch( \textcolor{stringliteral}{'S'} ) / slamch( \textcolor{stringliteral}{'E'} )
00162          knt = 0
...
00169             knt = knt + 1
00170             \textcolor{keyword}{CALL }sscal( n-1, rsafmn, x, incx )
...
00178             xnorm = snrm2( n-1, x, incx )
00179             beta = -sign( slapy2( alpha, xnorm ), alpha )
00180 \textcolor{keywordflow}{         END IF}
00181          tau = ( beta-alpha ) / beta
00182          \textcolor{keyword}{CALL }sscal( n-1, one / ( alpha-beta ), x, incx )
...
00194 \textcolor{comment}{*     End of SLARFG}
