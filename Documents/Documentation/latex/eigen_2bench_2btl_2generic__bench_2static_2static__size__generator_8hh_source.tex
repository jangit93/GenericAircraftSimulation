\hypertarget{eigen_2bench_2btl_2generic__bench_2static_2static__size__generator_8hh_source}{}\section{eigen/bench/btl/generic\+\_\+bench/static/static\+\_\+size\+\_\+generator.hh}
\label{eigen_2bench_2btl_2generic__bench_2static_2static__size__generator_8hh_source}\index{static\+\_\+size\+\_\+generator.\+hh@{static\+\_\+size\+\_\+generator.\+hh}}
...
00028 \textcolor{keyword}{template} <\textcolor{keywordtype}{int} SIZE,\textcolor{keyword}{template}<\textcolor{keyword}{class}> \textcolor{keyword}{class }Perf\_Analyzer, \textcolor{keyword}{template}<\textcolor{keyword}{class}> \textcolor{keyword}{class }Action, \textcolor{keyword}{template}<\textcolor{keyword}{class},\textcolor{keywordtype}{int}> \textcolor{keyword}{
      class }Interface> 
\Hypertarget{eigen_2bench_2btl_2generic__bench_2static_2static__size__generator_8hh_source_l00029}\hyperlink{structstatic__size__generator}{00029} \textcolor{keyword}{struct }\hyperlink{structstatic__size__generator}{static\_size\_generator}\{
...
00043 \textcolor{keyword}{template} <\textcolor{keyword}{template}<\textcolor{keyword}{class}> \textcolor{keyword}{class }Perf\_Analyzer, \textcolor{keyword}{template}<\textcolor{keyword}{class}> \textcolor{keyword}{class }Action, \textcolor{keyword}{template}<\textcolor{keyword}{class},\textcolor{keywordtype}{int}> \textcolor{keyword}{class }
      Interface> 
\Hypertarget{eigen_2bench_2btl_2generic__bench_2static_2static__size__generator_8hh_source_l00044}\hyperlink{structstatic__size__generator_3_011_00_01_perf___analyzer_00_01_action_00_01_interface_01_4}{00044} \textcolor{keyword}{struct }\hyperlink{structstatic__size__generator}{static\_size\_generator}<1,Perf\_Analyzer,Action,Interface>\{  
