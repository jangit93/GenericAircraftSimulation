\hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source}{}\section{eigen/\+Eigen/src/\+Core/arch/\+Alti\+Vec/\+Complex.h}
\label{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source}\index{Complex.\+h@{Complex.\+h}}
...
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00030}\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{00030} \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}
00031 \{
...
00035 \};
00036 
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00037}\hyperlink{struct_eigen_1_1internal_1_1packet__traits_3_01std_1_1complex_3_01float_01_4_01_4}{00037} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1packet__traits}{packet\_traits}<\hyperlink{namespacestd}{std}::\hyperlink{structcomplex}{complex}<float> >  : 
...
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00179}\hyperlink{struct_eigen_1_1internal_1_1palign__impl_3_01_offset_00_01_packet2cf_01_4}{00179} \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1palign__impl}{palign\_impl}<Offset,\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}>
00180 \{
...
00196   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmadd(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& x, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& y, \textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& c)\textcolor{keyword}{ const}
00197 \textcolor{keyword}{  }\{ \textcolor{keywordflow}{return} padd(pmul(x,y),c); \}
00198 
00199   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmul(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& a, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& b)\textcolor{keyword}{ const}
00200 \textcolor{keyword}{  }\{
00201     \textcolor{keywordflow}{return} internal::pmul(a, pconj(b));
00202   \}
00203 \};
00204 
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00205}\hyperlink{struct_eigen_1_1internal_1_1conj__helper_3_01_packet2cf_00_01_packet2cf_00_01true_00_01false_01_4}{00205} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper}<\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, true,false>
00206 \{
00207   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmadd(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& x, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& y, \textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& c)\textcolor{keyword}{ const}
00208 \textcolor{keyword}{  }\{ \textcolor{keywordflow}{return} padd(pmul(x,y),c); \}
00209 
00210   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmul(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& a, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& b)\textcolor{keyword}{ const}
...
00214 \};
00215 
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00216}\hyperlink{struct_eigen_1_1internal_1_1conj__helper_3_01_packet2cf_00_01_packet2cf_00_01true_00_01true_01_4}{00216} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper}<\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, true,true>
00217 \{
00218   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmadd(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& x, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& y, \textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& c)\textcolor{keyword}{ const}
00219 \textcolor{keyword}{  }\{ \textcolor{keywordflow}{return} padd(pmul(x,y),c); \}
00220 
00221   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmul(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& a, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& b)\textcolor{keyword}{ const}
...
00225 \};
00226 
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00227}\hyperlink{struct_eigen_1_1internal_1_1conj__helper_3_01_packet4f_00_01_packet2cf_00_01false_00_01false_01_4}{00227} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper}<\hyperlink{struct_eigen_1_1internal_1_1_packet4f}{Packet4f}, \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, false,false>
00228 \{
00229   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmadd(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet4f}{Packet4f}& x, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& y, \textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& c)\textcolor{keyword}{ const}
00230 \textcolor{keyword}{  }\{ \textcolor{keywordflow}{return} padd(c, pmul(x,y)); \}
00231 
00232   EIGEN\_STRONG\_INLINE \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf} pmul(\textcolor{keyword}{const} \hyperlink{struct_eigen_1_1internal_1_1_packet4f}{Packet4f}& x, \textcolor{keyword}{const} 
      \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}& y)\textcolor{keyword}{ const}
00233 \textcolor{keyword}{  }\{ \textcolor{keywordflow}{return} \hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}(internal::pmul<Packet4f>(x, y.v)); \}
00234 \};
00235 
\Hypertarget{eigen_2_eigen_2src_2_core_2arch_2_alti_vec_2_complex_8h_source_l00236}\hyperlink{struct_eigen_1_1internal_1_1conj__helper_3_01_packet2cf_00_01_packet4f_00_01false_00_01false_01_4}{00236} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{struct_eigen_1_1internal_1_1conj__helper}{conj\_helper}<\hyperlink{struct_eigen_1_1internal_1_1_packet2cf}{Packet2cf}, \hyperlink{struct_eigen_1_1internal_1_1_packet4f}{Packet4f}, false,false>
00237 \{
