\hypertarget{matio_2visual__studio_2test_2eigen_2lapack_2slarfb_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/lapack/slarfb.f}
\label{matio_2visual__studio_2test_2eigen_2lapack_2slarfb_8f_source}\index{slarfb.\+f@{slarfb.\+f}}

\begin{DoxyCode}
00001 \textcolor{comment}{*> \(\backslash\)brief \(\backslash\)b SLARFB}
...
00009 \textcolor{comment}{*> Download SLARFB + dependencies }
00010 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack\_routine/slarfb.f"> }
00011 \textcolor{comment}{*> [TGZ]</a> }
00012 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack\_routine/slarfb.f"> }
00013 \textcolor{comment}{*> [ZIP]</a> }
00014 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack\_routine/slarfb.f"> }
...
00021 \textcolor{comment}{*       SUBROUTINE SLARFB( SIDE, TRANS, DIRECT, STOREV, M, N, K, V, LDV,}
...
00029 \textcolor{comment}{*       REAL               C( LDC, * ), T( LDT, * ), V( LDV, * ),}
...
00300                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Lower'}, \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Unit'},
...
00323                   \textcolor{keyword}{CALL }scopy( lastc, c( 1, j ), 1, work( 1, j ), 1 )
00324    40          \textcolor{keywordflow}{CONTINUE}
00325 \textcolor{comment}{*}
00326 \textcolor{comment}{*              W := W * V1}
00327 \textcolor{comment}{*}
00328                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Lower'}, \textcolor{stringliteral}{'No transpose'}, \textcolor{stringliteral}{'Unit'},
...
00334                   \textcolor{keyword}{CALL }sgemm( \textcolor{stringliteral}{'No transpose'}, \textcolor{stringliteral}{'No transpose'},
...
00469                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Lower'}, trans, \textcolor{stringliteral}{'Non-unit'},
...
00478                   \textcolor{keyword}{CALL }sgemm( \textcolor{stringliteral}{'No transpose'}, \textcolor{stringliteral}{'Transpose'},
...
00485                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Upper'}, \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Unit'},
...
00519                   \textcolor{keyword}{CALL }scopy( lastc, c( j, 1 ), ldc, work( 1, j ), 1 )
00520   130          \textcolor{keywordflow}{CONTINUE}
00521 \textcolor{comment}{*}
00522 \textcolor{comment}{*              W := W * V1**T}
00523 \textcolor{comment}{*}
00524                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Upper'}, \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Unit'},
...
00530                   \textcolor{keyword}{CALL }sgemm( \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Transpose'},
...
00538                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Upper'}, transt, \textcolor{stringliteral}{'Non-unit'},
...
00547                   \textcolor{keyword}{CALL }sgemm( \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Transpose'},
...
00555                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Upper'}, \textcolor{stringliteral}{'No transpose'}, \textcolor{stringliteral}{'Unit'},
...
00578                   \textcolor{keyword}{CALL }scopy( lastc, c( 1, j ), 1, work( 1, j ), 1 )
00579   160          \textcolor{keywordflow}{CONTINUE}
00580 \textcolor{comment}{*}
00581 \textcolor{comment}{*              W := W * V1**T}
00582 \textcolor{comment}{*}
00583                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Upper'}, \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Unit'},
...
00681                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Lower'}, \textcolor{stringliteral}{'No transpose'}, \textcolor{stringliteral}{'Unit'},
...
00705                   \textcolor{keyword}{CALL }scopy( lastc, c( 1, lastv-k+j ), 1,
00706      $                 work( 1, j ), 1 )
00707   220          \textcolor{keywordflow}{CONTINUE}
00708 \textcolor{comment}{*}
00709 \textcolor{comment}{*              W := W * V2**T}
00710 \textcolor{comment}{*}
00711                \textcolor{keyword}{CALL }strmm( \textcolor{stringliteral}{'Right'}, \textcolor{stringliteral}{'Lower'}, \textcolor{stringliteral}{'Transpose'}, \textcolor{stringliteral}{'Unit'},
