\hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source}{}\section{eigen/unsupported/test/cxx11\+\_\+meta.cpp}
\label{eigen_2unsupported_2test_2cxx11__meta_8cpp_source}\index{cxx11\+\_\+meta.\+cpp@{cxx11\+\_\+meta.\+cpp}}
...
00049 
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00050}\hyperlink{structdummy__a}{00050} \textcolor{keyword}{struct }\hyperlink{structdummy__a}{dummy\_a} \{\};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00051}\hyperlink{structdummy__b}{00051} \textcolor{keyword}{struct }\hyperlink{structdummy__b}{dummy\_b} \{\};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00052}\hyperlink{structdummy__c}{00052} \textcolor{keyword}{struct }\hyperlink{structdummy__c}{dummy\_c} \{\};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00053}\hyperlink{structdummy__d}{00053} \textcolor{keyword}{struct }\hyperlink{structdummy__d}{dummy\_d} \{\};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00054}\hyperlink{structdummy__e}{00054} \textcolor{keyword}{struct }\hyperlink{structdummy__e}{dummy\_e} \{\};
00055 
00056 \textcolor{comment}{// dummy operation for testing apply}
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00057}\hyperlink{structdummy__op}{00057} \textcolor{keyword}{template}<\textcolor{keyword}{typename} A, \textcolor{keyword}{typename} B> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00058}\hyperlink{structdummy__op_3_01dummy__a_00_01dummy__b_01_4}{00058} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__a}{dummy\_a}, \hyperlink{structdummy__b}{dummy\_b}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__c}{dummy\_c} \hyperlink{structdummy__c}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00059}\hyperlink{structdummy__op_3_01dummy__b_00_01dummy__a_01_4}{00059} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__b}{dummy\_b}, \hyperlink{structdummy__a}{dummy\_a}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__d}{dummy\_d} \hyperlink{structdummy__d}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00060}\hyperlink{structdummy__op_3_01dummy__b_00_01dummy__c_01_4}{00060} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__b}{dummy\_b}, \hyperlink{structdummy__c}{dummy\_c}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__a}{dummy\_a} \hyperlink{structdummy__a}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00061}\hyperlink{structdummy__op_3_01dummy__c_00_01dummy__b_01_4}{00061} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__c}{dummy\_c}, \hyperlink{structdummy__b}{dummy\_b}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__d}{dummy\_d} \hyperlink{structdummy__d}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00062}\hyperlink{structdummy__op_3_01dummy__c_00_01dummy__a_01_4}{00062} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__c}{dummy\_c}, \hyperlink{structdummy__a}{dummy\_a}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__b}{dummy\_b} \hyperlink{structdummy__b}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00063}\hyperlink{structdummy__op_3_01dummy__a_00_01dummy__c_01_4}{00063} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__a}{dummy\_a}, \hyperlink{structdummy__c}{dummy\_c}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__d}{dummy\_d} \hyperlink{structdummy__d}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00064}\hyperlink{structdummy__op_3_01dummy__a_00_01dummy__a_01_4}{00064} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__a}{dummy\_a}, \hyperlink{structdummy__a}{dummy\_a}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__e}{dummy\_e} \hyperlink{structdummy__e}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00065}\hyperlink{structdummy__op_3_01dummy__b_00_01dummy__b_01_4}{00065} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__b}{dummy\_b}, \hyperlink{structdummy__b}{dummy\_b}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__e}{dummy\_e} \hyperlink{structdummy__e}{type}; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00066}\hyperlink{structdummy__op_3_01dummy__c_00_01dummy__c_01_4}{00066} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__op}{dummy\_op}<\hyperlink{structdummy__c}{dummy\_c}, \hyperlink{structdummy__c}{dummy\_c}> \{ \textcolor{keyword}{typedef} 
      \hyperlink{structdummy__e}{dummy\_e} \hyperlink{structdummy__e}{type}; \};
00067 
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00068}\hyperlink{structdummy__test}{00068} \textcolor{keyword}{template}<\textcolor{keyword}{typename} A, \textcolor{keyword}{typename} B> \textcolor{keyword}{struct }\hyperlink{structdummy__test}{dummy\_test} \{ constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{bool} value = \textcolor{keyword}{false}; 
      constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{int} global\_flags = 0; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00069}\hyperlink{structdummy__test_3_01dummy__a_00_01dummy__a_01_4}{00069} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__test}{dummy\_test}<\hyperlink{structdummy__a}{dummy\_a}, \hyperlink{structdummy__a}{dummy\_a}>     \{ constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{bool} value = \textcolor{keyword}{
      true};  constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{int} global\_flags = 1; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00070}\hyperlink{structdummy__test_3_01dummy__b_00_01dummy__b_01_4}{00070} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__test}{dummy\_test}<\hyperlink{structdummy__b}{dummy\_b}, \hyperlink{structdummy__b}{dummy\_b}>     \{ constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{bool} value = \textcolor{keyword}{
      true};  constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{int} global\_flags = 2; \};
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00071}\hyperlink{structdummy__test_3_01dummy__c_00_01dummy__c_01_4}{00071} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structdummy__test}{dummy\_test}<\hyperlink{structdummy__c}{dummy\_c}, \hyperlink{structdummy__c}{dummy\_c}>     \{ constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{bool} value = \textcolor{keyword}{
      true};  constexpr \textcolor{keyword}{static} \textcolor{keywordtype}{int} global\_flags = 4; \};
00072 
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00073}\hyperlink{structtimes2__op}{00073} \textcolor{keyword}{struct }\hyperlink{structtimes2__op}{times2\_op} \{ \textcolor{keyword}{template}<\textcolor{keyword}{typename} A> \textcolor{keyword}{static} \hyperlink{group___core___module_class_eigen_1_1_matrix}{A} run(\hyperlink{group___core___module_class_eigen_1_1_matrix}{A} v) \{ \textcolor{keywordflow}{return} v * 2; \} \};
00074 
\Hypertarget{eigen_2unsupported_2test_2cxx11__meta_8cpp_source_l00075}\hyperlink{structdummy__inst}{00075} \textcolor{keyword}{struct }\hyperlink{structdummy__inst}{dummy\_inst}
00076 \{
