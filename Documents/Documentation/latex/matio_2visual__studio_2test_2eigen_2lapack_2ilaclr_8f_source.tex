\hypertarget{matio_2visual__studio_2test_2eigen_2lapack_2ilaclr_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/lapack/ilaclr.f}
\label{matio_2visual__studio_2test_2eigen_2lapack_2ilaclr_8f_source}\index{ilaclr.\+f@{ilaclr.\+f}}

\begin{DoxyCode}
00001 \textcolor{comment}{*> \(\backslash\)brief \(\backslash\)b ILACLR}
...
00009 \textcolor{comment}{*> Download ILACLR + dependencies }
00010 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack\_routine/ilaclr.f"> }
00011 \textcolor{comment}{*> [TGZ]</a> }
00012 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack\_routine/ilaclr.f"> }
00013 \textcolor{comment}{*> [ZIP]</a> }
00014 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack\_routine/ilaclr.f"> }
...
00021 \textcolor{comment}{*       INTEGER FUNCTION ILACLR( M, N, A, LDA )}
...
00036 \textcolor{comment}{*> ILACLR scans A for its last non-zero row.}
...
00056 \textcolor{comment}{*>          A is array, dimension (LDA,N)}
...
00079 \textcolor{keyword}{      INTEGER }\textcolor{keyword}{FUNCTION }ilaclr( M, N, A, LDA )
