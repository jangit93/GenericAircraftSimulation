\hypertarget{matio_2visual__studio_2test_2eigen_2lapack_2ilazlc_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/lapack/ilazlc.f}
\label{matio_2visual__studio_2test_2eigen_2lapack_2ilazlc_8f_source}\index{ilazlc.\+f@{ilazlc.\+f}}

\begin{DoxyCode}
00001 \textcolor{comment}{*> \(\backslash\)brief \(\backslash\)b ILAZLC}
...
00009 \textcolor{comment}{*> Download ILAZLC + dependencies }
00010 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack\_routine/ilazlc.f"> }
00011 \textcolor{comment}{*> [TGZ]</a> }
00012 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack\_routine/ilazlc.f"> }
00013 \textcolor{comment}{*> [ZIP]</a> }
00014 \textcolor{comment}{*> <a
       href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack\_routine/ilazlc.f"> }
...
00021 \textcolor{comment}{*       INTEGER FUNCTION ILAZLC( M, N, A, LDA )}
...
00036 \textcolor{comment}{*> ILAZLC scans A for its last non-zero column.}
...
00079 \textcolor{keyword}{      INTEGER }\textcolor{keyword}{FUNCTION }ilazlc( M, N, A, LDA )
...
00111          \textcolor{keywordflow}{DO} ilazlc = n, 1, -1
00112             \textcolor{keywordflow}{DO} i = 1, m
00113                \textcolor{keywordflow}{IF}( a(i, ilazlc).NE.zero ) \textcolor{keywordflow}{RETURN}
