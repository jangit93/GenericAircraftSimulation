\hypertarget{matio_2visual__studio_2test_2eigen_2blas_2testing_2sblat2_8f_source}{}\section{matio/visual\+\_\+studio/test/eigen/blas/testing/sblat2.f}
\label{matio_2visual__studio_2test_2eigen_2blas_2testing_2sblat2_8f_source}\index{sblat2.\+f@{sblat2.\+f}}
...
00125       \textcolor{keywordtype}{REAL}               eps, err, thresh
...
00134       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ),
...
00144       \textcolor{keywordtype}{REAL}               sdiff
00145       \textcolor{keywordtype}{LOGICAL}            lse
00146       \textcolor{keywordtype}{EXTERNAL}           sdiff, lse
00147 \textcolor{comment}{*     .. External Subroutines ..}
00148       \textcolor{keywordtype}{EXTERNAL}           schk1, schk2, schk3, schk4, schk5, schk6,
00149      $                   schke, smvch
...
00160       \textcolor{keyword}{DATA}               snames/\textcolor{stringliteral}{'SGEMV '}, \textcolor{stringliteral}{'SGBMV '}, \textcolor{stringliteral}{'SSYMV '}, \textcolor{stringliteral}{'SSBMV '},
00161      $                   \textcolor{stringliteral}{'SSPMV '}, \textcolor{stringliteral}{'STRMV '}, \textcolor{stringliteral}{'STBMV '}, \textcolor{stringliteral}{'STPMV '},
00162      $                   \textcolor{stringliteral}{'STRSV '}, \textcolor{stringliteral}{'STBSV '}, \textcolor{stringliteral}{'STPSV '}, \textcolor{stringliteral}{'SGER  '},
00163      $                   \textcolor{stringliteral}{'SSYR  '}, \textcolor{stringliteral}{'SSPR  '}, \textcolor{stringliteral}{'SSYR2 '}, \textcolor{stringliteral}{'SSPR2 '}/
...
00330                \textcolor{keyword}{CALL }schke( isnum, snames( isnum ), nout )
...
00339      $              190, 190 )isnum
00340 \textcolor{comment}{*           Test SGEMV, 01, and SGBMV, 02.}
00341   140       \textcolor{keyword}{CALL }schk1( snames( isnum ), eps, thresh, nout, ntra, trace,
...
00346 \textcolor{comment}{*           Test SSYMV, 03, SSBMV, 04, and SSPMV, 05.}
00347   150       \textcolor{keyword}{CALL }schk2( snames( isnum ), eps, thresh, nout, ntra, trace,
...
00352 \textcolor{comment}{*           Test STRMV, 06, STBMV, 07, STPMV, 08,}
00353 \textcolor{comment}{*           STRSV, 09, STBSV, 10, and STPSV, 11.}
00354   160       \textcolor{keyword}{CALL }schk3( snames( isnum ), eps, thresh, nout, ntra, trace,
00355      $                  rewi, fatal, nidim, idim, nkb, kb, ninc, inc,
00356      $                  nmax, incmax, a, aa, as, y, yy, ys, yt, g, z )
00357             \textcolor{keywordflow}{GO TO} 200
00358 \textcolor{comment}{*           Test SGER, 12.}
00359   170       \textcolor{keyword}{CALL }schk4( snames( isnum ), eps, thresh, nout, ntra, trace,
...
00364 \textcolor{comment}{*           Test SSYR, 13, and SSPR, 14.}
00365   180       \textcolor{keyword}{CALL }schk5( snames( isnum ), eps, thresh, nout, ntra, trace,
...
00444       \textcolor{keywordtype}{REAL}               zero, half
00445       parameter( zero = 0.0, half = 0.5 )
00446 \textcolor{comment}{*     .. Scalar Arguments ..}
00447       \textcolor{keywordtype}{REAL}               eps, thresh
...
00453       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ), alf( nalf ),
...
00461       \textcolor{keywordtype}{REAL}               alpha, als, beta, bls, err, errmax, transl
...
00472       \textcolor{keywordtype}{LOGICAL}            lse, lseres
00473       \textcolor{keywordtype}{EXTERNAL}           lse, lseres
00474 \textcolor{comment}{*     .. External Subroutines ..}
00475       \textcolor{keywordtype}{EXTERNAL}           sgbmv, sgemv, smake, smvch
...
00657                                     isame( 10 ) = lseres( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, 1,
00658      $                                            ml, ys, yy,
00659      $                                            abs( incy ) )
...
00944      $                           rewind ntra
00945                               \textcolor{keyword}{CALL }ssymv( uplo, n, alpha, aa, lda, xx,
...
00953      $                           rewind ntra
00954                               \textcolor{keyword}{CALL }ssbmv( uplo, n, k, alpha, aa, lda,
...
00961      $                           rewind ntra
00962                               \textcolor{keyword}{CALL }sspmv( uplo, n, alpha, aa, xx, incx,
00963      $                                    beta, yy, incy )
...
01111 \textcolor{comment}{*     End of SCHK2.}
01112 \textcolor{comment}{*}
01113 \textcolor{keyword}{      END}
01114 \textcolor{keyword}{      SUBROUTINE }schk3( SNAME, EPS, THRESH, NOUT, NTRA, TRACE, REWI,
01115      $                  FATAL, NIDIM, IDIM, NKB, KB, NINC, INC, NMAX,
01116      $                  INCMAX, A, AA, AS, X, XX, XS, XT, G, Z )
01117 \textcolor{comment}{*}
01118 \textcolor{comment}{*  Tests STRMV, STBMV, STPMV, STRSV, STBSV and STPSV.}
...
01127       \textcolor{keywordtype}{REAL}               zero, half, one
01128       parameter( zero = 0.0, half = 0.5, one = 1.0 )
01129 \textcolor{comment}{*     .. Scalar Arguments ..}
01130       \textcolor{keywordtype}{REAL}               eps, thresh
...
01135       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ),
...
01141       \textcolor{keywordtype}{REAL}               err, errmax, transl
...
01151       \textcolor{keywordtype}{LOGICAL}            lse, lseres
01152       \textcolor{keywordtype}{EXTERNAL}           lse, lseres
01153 \textcolor{comment}{*     .. External Subroutines ..}
01154       \textcolor{keywordtype}{EXTERNAL}           smake, smvch, stbmv, stbsv, stpmv, stpsv,
01155      $                   strmv, strsv
...
01229                      transl = zero
01230                      \textcolor{keyword}{CALL }smake( sname( 2: 3 ), uplo, diag, n, n, a,
...
01239                         transl = half
01240                         \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, n, x, 1, xx,
...
01337                            isame( 5 ) = lse( as, aa, laa )
01338                            isame( 6 ) = ldas.EQ.lda
01339                            \textcolor{keywordflow}{IF}( null )\textcolor{keywordflow}{THEN}
01340                               isame( 7 ) = lse( xs, xx, lx )
01341                            \textcolor{keywordflow}{ELSE}
01342                               isame( 7 ) = lseres( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, 1, n, xs,
01343      $                                     xx, abs( incx ) )
...
01348                            isame( 6 ) = lse( as, aa, laa )
01349                            isame( 7 ) = ldas.EQ.lda
01350                            \textcolor{keywordflow}{IF}( null )\textcolor{keywordflow}{THEN}
01351                               isame( 8 ) = lse( xs, xx, lx )
01352                            \textcolor{keywordflow}{ELSE}
01353                               isame( 8 ) = lseres( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, 1, n, xs,
01354      $                                     xx, abs( incx ) )
...
01358                            isame( 5 ) = lse( as, aa, laa )
01359                            \textcolor{keywordflow}{IF}( null )\textcolor{keywordflow}{THEN}
01360                               isame( 6 ) = lse( xs, xx, lx )
01361                            \textcolor{keywordflow}{ELSE}
01362                               isame( 6 ) = lseres( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, 1, n, xs,
01363      $                                     xx, abs( incx ) )
...
01476 \textcolor{comment}{*  Tests SGER.}
...
01485       \textcolor{keywordtype}{REAL}               zero, half, one
01486       parameter( zero = 0.0, half = 0.5, one = 1.0 )
01487 \textcolor{comment}{*     .. Scalar Arguments ..}
01488       \textcolor{keywordtype}{REAL}               eps, thresh
...
01493       \textcolor{keywordtype}{REAL}               a( nmax, nmax ), aa( nmax*nmax ), alf( nalf ),
...
01500       \textcolor{keywordtype}{REAL}               alpha, als, err, errmax, transl
...
01506       \textcolor{keywordtype}{REAL}               w( 1 )
01507       \textcolor{keywordtype}{LOGICAL}            isame( 13 )
01508 \textcolor{comment}{*     .. External Functions ..}
01509       \textcolor{keywordtype}{LOGICAL}            lse, lseres
01510       \textcolor{keywordtype}{EXTERNAL}           lse, lseres
01511 \textcolor{comment}{*     .. External Subroutines ..}
01512       \textcolor{keywordtype}{EXTERNAL}           sger, smake, smvch
...
01554                transl = half
01555                \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, m, x, 1, xx, abs( incx ),
...
01568                   transl = zero
01569                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, n, y, 1, yy,
...
01581                      transl = zero
01582                      \textcolor{keyword}{CALL }smake( sname( 2: 3 ), \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, m, n, a, nmax,
...
01611      $                  rewind ntra
01612                      \textcolor{keyword}{CALL }sger( m, n, alpha, xx, incx, yy, incy, aa,
01613      $                          lda )
...
01628                      isame( 4 ) = lse( xs, xx, lx )
01629                      isame( 5 ) = incxs.EQ.incx
01630                      isame( 6 ) = lse( ys, yy, ly )
01631                      isame( 7 ) = incys.EQ.incy
01632                      \textcolor{keywordflow}{IF}( null )\textcolor{keywordflow}{THEN}
01633                         isame( 8 ) = lse( as, aa, laa )
01634                      \textcolor{keywordflow}{ELSE}
01635                         isame( 8 ) = lseres( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, m, n, as, aa,
01636      $                               lda )
...
01823                transl = half
01824                \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, n, x, 1, xx, abs( incx ),
...
01837                   transl = zero
01838                   \textcolor{keyword}{CALL }smake( sname( 2: 3 ), uplo, \textcolor{stringliteral}{' '}, n, n, a, nmax,
...
01864      $                  rewind ntra
01865                      \textcolor{keyword}{CALL }ssyr( uplo, n, alpha, xx, incx, aa, lda )
...
01871      $                  rewind ntra
01872                      \textcolor{keyword}{CALL }sspr( uplo, n, alpha, xx, incx, aa )
...
02102                transl = half
02103                \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, n, x, 1, xx, abs( incx ),
...
02116                   transl = zero
02117                   \textcolor{keyword}{CALL }smake( \textcolor{stringliteral}{'GE'}, \textcolor{stringliteral}{' '}, \textcolor{stringliteral}{' '}, 1, n, y, 1, yy,
...
02130                      transl = zero
02131                      \textcolor{keyword}{CALL }smake( sname( 2: 3 ), uplo, \textcolor{stringliteral}{' '}, n, n, a,
...
02162      $                     rewind ntra
02163                         \textcolor{keyword}{CALL }ssyr2( uplo, n, alpha, xx, incx, yy, incy,
02164      $                              aa, lda )
...
02170      $                     rewind ntra
02171                         \textcolor{keyword}{CALL }sspr2( uplo, n, alpha, xx, incx, yy, incy,
02172      $                              aa )
...
02248                            \textcolor{keyword}{CALL }smvch( \textcolor{stringliteral}{'N'}, lj, 2, alpha, z( jj, 1 ),
...
02322 \textcolor{comment}{*     End of SCHK6.}
02323 \textcolor{comment}{*}
02324 \textcolor{keyword}{      END}
02325 \textcolor{keyword}{      SUBROUTINE }schke( ISNUM, SRNAMT, NOUT )
...
02344       \textcolor{keywordtype}{REAL}               alpha, beta
02345 \textcolor{comment}{*     .. Local Arrays ..}
02346       \textcolor{keywordtype}{REAL}               a( 1, 1 ), x( 1 ), y( 1 )
02347 \textcolor{comment}{*     .. External Subroutines ..}
02348       \textcolor{keywordtype}{EXTERNAL}           chkxer, sgbmv, sgemv, sger, ssbmv, sspmv, sspr,
02349      $                   sspr2, ssymv, ssyr, ssyr2, stbmv, stbsv, stpmv,
02350      $                   stpsv, strmv, strsv
...
02611       infot = 2
02612       \textcolor{keyword}{CALL }ssyr2( \textcolor{stringliteral}{'U'}, -1, alpha, x, 1, y, 1, a, 1 )
02613       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02614       infot = 5
02615       \textcolor{keyword}{CALL }ssyr2( \textcolor{stringliteral}{'U'}, 0, alpha, x, 0, y, 1, a, 1 )
02616       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02617       infot = 7
02618       \textcolor{keyword}{CALL }ssyr2( \textcolor{stringliteral}{'U'}, 0, alpha, x, 1, y, 0, a, 1 )
02619       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02620       infot = 9
02621       \textcolor{keyword}{CALL }ssyr2( \textcolor{stringliteral}{'U'}, 2, alpha, x, 1, y, 1, a, 1 )
02622       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02623       \textcolor{keywordflow}{GO TO} 170
02624   160 infot = 1
02625       \textcolor{keyword}{CALL }sspr2( \textcolor{stringliteral}{'/'}, 0, alpha, x, 1, y, 1, a )
02626       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02627       infot = 2
02628       \textcolor{keyword}{CALL }sspr2( \textcolor{stringliteral}{'U'}, -1, alpha, x, 1, y, 1, a )
02629       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02630       infot = 5
02631       \textcolor{keyword}{CALL }sspr2( \textcolor{stringliteral}{'U'}, 0, alpha, x, 0, y, 1, a )
02632       \textcolor{keyword}{CALL }chkxer( srnamt, infot, nout, lerr, ok )
02633       infot = 7
02634       \textcolor{keyword}{CALL }sspr2( \textcolor{stringliteral}{'U'}, 0, alpha, x, 1, y, 0, a )
...
02648 \textcolor{comment}{*     End of SCHKE.}
02649 \textcolor{comment}{*}
02650 \textcolor{keyword}{      END}
02651 \textcolor{keyword}{      SUBROUTINE }smake( TYPE, UPLO, DIAG, M, N, A, NMAX, AA, LDA, KL,
...
02668       \textcolor{keywordtype}{REAL}               zero, one
02669       parameter( zero = 0.0, one = 1.0 )
02670       \textcolor{keywordtype}{REAL}               rogue
02671       parameter( rogue = -1.0e10 )
02672 \textcolor{comment}{*     .. Scalar Arguments ..}
02673       \textcolor{keywordtype}{REAL}               transl
...
02679       \textcolor{keywordtype}{REAL}               a( nmax, * ), aa( * )
...
02684       \textcolor{keywordtype}{REAL}               sbeg
02685       \textcolor{keywordtype}{EXTERNAL}           sbeg
...
02824 \textcolor{comment}{*     End of SMAKE.}
02825 \textcolor{comment}{*}
02826 \textcolor{keyword}{      END}
02827 \textcolor{keyword}{      SUBROUTINE }smvch( TRANS, M, N, ALPHA, A, NMAX, X, INCX, BETA, Y,
...
02941 \textcolor{comment}{*     End of SMVCH.}
02942 \textcolor{comment}{*}
02943 \textcolor{keyword}{      END}
02944 \textcolor{keyword}{      LOGICAL }\textcolor{keyword}{FUNCTION }lse( RI, RJ, LR )
...
02957       \textcolor{keywordtype}{REAL}               ri( * ), rj( * )
...
02971 \textcolor{comment}{*     End of LSE.}
02972 \textcolor{comment}{*}
02973 \textcolor{keyword}{      END}
02974 \textcolor{keyword}{      LOGICAL }\textcolor{keyword}{FUNCTION }lseres( TYPE, UPLO, M, N, AA, AS, LDA )
...
02991       \textcolor{keywordtype}{REAL}               aa( lda, * ), as( lda, * )
...
03076 \textcolor{comment}{*     End of SBEG.}
03077 \textcolor{comment}{*}
03078 \textcolor{keyword}{      END}
03079 \textcolor{keyword}{      REAL }\textcolor{keyword}{FUNCTION }sdiff( X, Y )
