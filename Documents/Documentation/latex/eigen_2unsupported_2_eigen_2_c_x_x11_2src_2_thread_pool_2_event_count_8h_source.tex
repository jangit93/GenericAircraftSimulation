\hypertarget{eigen_2unsupported_2_eigen_2_c_x_x11_2src_2_thread_pool_2_event_count_8h_source}{}\section{eigen/unsupported/\+Eigen/\+C\+X\+X11/src/\+Thread\+Pool/\+Event\+Count.h}
\label{eigen_2unsupported_2_eigen_2_c_x_x11_2src_2_thread_pool_2_event_count_8h_source}\index{Event\+Count.\+h@{Event\+Count.\+h}}
...
\Hypertarget{eigen_2unsupported_2_eigen_2_c_x_x11_2src_2_thread_pool_2_event_count_8h_source_l00049}\hyperlink{class_eigen_1_1_event_count}{00049} \textcolor{keyword}{class }\hyperlink{class_eigen_1_1_event_count}{EventCount} \{
...
00168   \}
00169 
\Hypertarget{eigen_2unsupported_2_eigen_2_c_x_x11_2src_2_thread_pool_2_event_count_8h_source_l00170}\hyperlink{class_eigen_1_1_event_count_1_1_waiter}{00170}   \textcolor{keyword}{class }\hyperlink{class_eigen_1_1_event_count_1_1_waiter}{Waiter} \{
...
00202   \hyperlink{class_eigen_1_1_max_size_vector}{MaxSizeVector<Waiter>}& waiters\_;
00203 
00204   \textcolor{keywordtype}{void} Park(\hyperlink{class_eigen_1_1_event_count_1_1_waiter}{Waiter}* w) \{
...
00210   \}
00211 
00212   \textcolor{keywordtype}{void} Unpark(\hyperlink{class_eigen_1_1_event_count_1_1_waiter}{Waiter}* waiters) \{
00213     \hyperlink{class_eigen_1_1_event_count_1_1_waiter}{Waiter}* next = \textcolor{keyword}{nullptr};
00214     \textcolor{keywordflow}{for} (\hyperlink{class_eigen_1_1_event_count_1_1_waiter}{Waiter}* w = waiters; w; w = next) \{
00215       next = w->next.load(std::memory\_order\_relaxed);
00216       \textcolor{keywordtype}{unsigned} \hyperlink{structstate}{state};
00217       \{
...
00225   \}
00226 
00227   \hyperlink{class_eigen_1_1_event_count}{EventCount}(\textcolor{keyword}{const} \hyperlink{class_eigen_1_1_event_count}{EventCount}&) = \textcolor{keyword}{delete};
00228   \textcolor{keywordtype}{void} operator=(\textcolor{keyword}{const} \hyperlink{class_eigen_1_1_event_count}{EventCount}&) = \textcolor{keyword}{delete};
00229 \};
00230 
