\hypertarget{eigen_2bench_2product__threshold_8cpp_source}{}\section{eigen/bench/product\+\_\+threshold.cpp}
\label{eigen_2bench_2product__threshold_8cpp_source}\index{product\+\_\+threshold.\+cpp@{product\+\_\+threshold.\+cpp}}
...
00010 
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00011}\hyperlink{structmap__size}{00011} \textcolor{keyword}{template}<\textcolor{keywordtype}{int} S> \textcolor{keyword}{struct }\hyperlink{structmap__size}{map\_size} \{ \textcolor{keyword}{enum} \{ ret = S \}; \};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00012}\hyperlink{structmap__size_3_0110_01_4}{00012} \textcolor{keyword}{template}<>  \textcolor{keyword}{struct }\hyperlink{structmap__size}{map\_size}<10> \{ \textcolor{keyword}{enum} \{ ret = 20 \}; \};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00013}\hyperlink{structmap__size_3_0111_01_4}{00013} \textcolor{keyword}{template}<>  \textcolor{keyword}{struct }\hyperlink{structmap__size}{map\_size}<11> \{ \textcolor{keyword}{enum} \{ ret = 50 \}; \};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00014}\hyperlink{structmap__size_3_0112_01_4}{00014} \textcolor{keyword}{template}<>  \textcolor{keyword}{struct }\hyperlink{structmap__size}{map\_size}<12> \{ \textcolor{keyword}{enum} \{ ret = 100 \}; \};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00015}\hyperlink{structmap__size_3_0113_01_4}{00015} \textcolor{keyword}{template}<>  \textcolor{keyword}{struct }\hyperlink{structmap__size}{map\_size}<13> \{ \textcolor{keyword}{enum} \{ ret = 300 \}; \};
00016 
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00017}\hyperlink{structalt__prod}{00017} \textcolor{keyword}{template}<\textcolor{keywordtype}{int} M, \textcolor{keywordtype}{int} N,\textcolor{keywordtype}{int} K> \textcolor{keyword}{struct }\hyperlink{structalt__prod}{alt\_prod}
00018 \{
...
00067 \}
00068 
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00069}\hyperlink{structprint__n}{00069} \textcolor{keyword}{template}<\textcolor{keywordtype}{int} N> \textcolor{keyword}{struct }\hyperlink{structprint__n}{print\_n};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00070}\hyperlink{structloop__on__m}{00070} \textcolor{keyword}{template}<\textcolor{keywordtype}{int} M, \textcolor{keywordtype}{int} N, \textcolor{keywordtype}{int} K> \textcolor{keyword}{struct }\hyperlink{structloop__on__m}{loop\_on\_m};
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00071}\hyperlink{structloop__on__n}{00071} \textcolor{keyword}{template}<\textcolor{keywordtype}{int} M, \textcolor{keywordtype}{int} N, \textcolor{keywordtype}{int} K, \textcolor{keyword}{typename} Scalar, \textcolor{keywordtype}{int} Mode> \textcolor{keyword}{struct }\hyperlink{structloop__on__n}{loop\_on\_n};
00072 
00073 \textcolor{keyword}{template}<\textcolor{keywordtype}{int} M, \textcolor{keywordtype}{int} N, \textcolor{keywordtype}{int} K>
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00074}\hyperlink{structloop__on__k}{00074} \textcolor{keyword}{struct }\hyperlink{structloop__on__k}{loop\_on\_k}
00075 \{
...
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00090}\hyperlink{structloop__on__k_3_01_m_00_01_n_00_01_e_n_d_01_4}{00090} \textcolor{keyword}{struct }\hyperlink{structloop__on__k}{loop\_on\_k}<\hyperlink{group___core___module_class_eigen_1_1_matrix}{M},N,END> \{ \textcolor{keyword}{static} \textcolor{keywordtype}{void} run()\{\} \};
00091 
00092 
...
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00111}\hyperlink{structloop__on__m_3_01_e_n_d_00_01_n_00_01_k_01_4}{00111} \textcolor{keyword}{struct }\hyperlink{structloop__on__m}{loop\_on\_m}<END,N,K> \{ \textcolor{keyword}{static} \textcolor{keywordtype}{void} run()\{\} \};
00112 
...
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00125}\hyperlink{structloop__on__n_3_01_m_00_01_e_n_d_00_01_k_00_01_scalar_00_01_mode_01_4}{00125} \textcolor{keyword}{struct }\hyperlink{structloop__on__n}{loop\_on\_n}<\hyperlink{group___core___module_class_eigen_1_1_matrix}{M},END,K,Scalar,Mode> \{ \textcolor{keyword}{static} \textcolor{keywordtype}{void} run()\{\} \};
00126 
...
00134 \};
00135 
\Hypertarget{eigen_2bench_2product__threshold_8cpp_source_l00136}\hyperlink{structprint__n_3_01_e_n_d_01_4}{00136} \textcolor{keyword}{template}<> \textcolor{keyword}{struct }\hyperlink{structprint__n}{print\_n}<END> \{ \textcolor{keyword}{static} \textcolor{keywordtype}{void} run()\{\} \};
00137 
